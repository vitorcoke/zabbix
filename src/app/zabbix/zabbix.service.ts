  ...
  async sendAlertSucesso(item: string) {
    exec(
      ...
      (err, stdout, stderr) => {
        ...
        console.log(
          `${stdout} zabbix_sender -z 192.168.3.11 -s "RAMAIS-PORTARIA-FULL" -k ramal.${item} -o "OK"`,
        );
        console.log(
          `${stderr} zabbix_sender -z 192.168.3.11 -s "RAMAIS-PORTARIA-FULL" -k ramal.${item} -o "OK"`,
        );
      },
    );
  }
